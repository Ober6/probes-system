...
class AnalyzerServiceTest {
  ...
  @Autowired InputDestination producer;
  @Autowired RangeProviderClient service;
  ...
  void testUpdateRangeInMap() throws InterruptedException {
    producer.send(
        new GenericMessage<SensorUpdateData>(new SensorUpdateData(SENSOR_ID, RANGE_UPDATED, null)),
        updateBindingName);
    Thread.sleep(1000);
